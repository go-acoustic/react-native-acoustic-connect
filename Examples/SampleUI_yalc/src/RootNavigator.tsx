...
// import { AcousticConnectRN, Connect } from 'react-native-acoustic-connect';
...
console.log('RootNavigator.tsx:Exported items from react-native-acoustic-connect:', AcousticConnectBeta);
